...
const Diery = ({ data }: any) => {
    ...
    return (
        <div
            className={`relative z-10 transition-all duration-700 ease-in-out text-black ${activePage === 0 ? "translate-x-0" : "translate-x-0"
                }`}
            ...
            >
                ...
                <Page color="bg-[#1DBD9C]">
                    <div className="text-black p-12 w-full h-full flex flex-col justify-between items-start text-left shadow-[inset_10px_0_20px_rgba(0,0,0,0.05)]">
                        <span className="bg-[#181818] text-[#1DBD9C] text-sm px-3 py-1 font-bold rounded-full">{data.title2}</span>
                        <div>

                            <div className="hat"><i className="fab fa-pied-piper-hat"></i></div>
                            <h1 className="text-6xl font-black leading-[0.85] tracking-tighter">{data.title}</h1>
                            <p className="text-sm font-bold opacity-40 uppercase tracking-widest mt-4">{data.title3}</p>
                        </div>
                    </div>
                </Page>

                <Page color="bg-gray-200">
                    <div className="p-8 h-full w-full text-sm">
                        <FormattedText text={data.diery.intro} />
                        <img src={me} alt="" className='mt-4 w-40' />
                        <p className="pageNum">1</p>
                    </div>
                </Page>

                <Page color="bg-gray-200" isLeft={true}>
                    <div className="p-8 w-full h-full text-sm">
                        <p>
                ...
                <Page color='bg-[#1DBD9C]'>
                    <div className="flex items-center justify-center w-full h-full">
                        <h2 className='text-4xl font-black leading-[0.85] tracking-tighter'>{data.title4}</h2>
                    </div>
                </Page>
            </HTMLFlipBook>
        </div>
