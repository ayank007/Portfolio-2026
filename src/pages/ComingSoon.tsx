    ...
    return (
        <div className="fixed inset-0 overflow-hidden bg-[#e0e0d1] flex items-center justify-center font-mono text-[#333] select-none touch-none">
            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center z-10">
                <p className="text-xl mb-4 opacity-70">Working On It</p>
                <div className="flex gap-2 md:gap-4 text-[3rem] font-black leading-none">
                    {['C', 'O', 'M', 'I', 'N', 'G', ' ', 'S', 'O', 'O', 'N'].map((num, i) => (
                        <span
                            key={i}
